...
const googleReviews = [
  {
    ...
    date: "51 weeks ago",
    rating: 5,
    text: "Thank you for the great services. My Boss is pleased with you guys.keep up the good work.",
    local: "Local Guide · 8 reviews",
  },
  {
    name: "Agyemang Joseph",
    initials: "ST",
    color: "#EA4335",
    date: "2 weeks ago",
    rating: 5,
    ...
    local: "Local Guide · 7 reviews",
  },
  {
    name: "Pepertual Konadu Ofosu",
    initials: "JR",
    color: "#34A853",
    date: "1 month ago",
    rating: 5,
    text: "I PATRONIZED THEM RECENTLY AND THEY DID AN EXCELLENT JOB.VERY AFFORDABLE AND THEY DELIVERED ON TIME AS WELL.",
    local: "6 reviews",
  },
  {
    name: "Kwaku Milli",
    ...
    date: "2 months ago",
    rating: 5,
    text: "Well what can I say you guys are doing great job. Thanks for your service.",
    local: "Local Guide · 5 reviews",
  },
  {
    name: "Joseph Kwame Fosu",
    initials: "TB",
    color: "#9C27B0",
    date: "3 months ago",
    rating: 5,
    text: "Good work, I am very pleased with the job, thank you very much.",
    local: "4 reviews",
  },
  {
    name: "Pepertual Konadu Ofosu",
